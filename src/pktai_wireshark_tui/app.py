...
class TitleBar(Container):
    ...
    def compose(self) -> ComposeResult:
        yield Container(
            ...
            Label("pktai Wireshark TUI", id="title"),
            id="titlebar-row",
        )
...
# Removed custom FileOpen modal in favor of textual-fspicker's FileOpen
...
class WiresharkTUI(App):
    CSS = """
    Screen {
        layout: vertical;
    }
    # Use the built-in Header/Footer for status
    """
